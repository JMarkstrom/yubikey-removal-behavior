...
//
#define MSG_REMOVED_NOACTION             ((DWORD)0x40010102L)

//
// MessageId: MSG_LOCK_FAILED
//
// MessageText:
//
// Failed to lock the workstation (Win32 error %1).
//
#define MSG_LOCK_FAILED                  ((DWORD)0x80010103L)

//
// MessageId: MSG_LOGOUT_FAILED
//
// MessageText:
//
// Failed to log off the user (Win32 error %1).
//
#define MSG_LOGOUT_FAILED                ((DWORD)0x80010104L)
